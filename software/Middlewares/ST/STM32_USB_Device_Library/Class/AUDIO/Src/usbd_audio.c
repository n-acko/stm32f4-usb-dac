...
#define AUDIO_PACKET_SZE_24(frq) \
  (uint8_t)(((frq / 1000U) * 2U * 3U) & 0xFFU), (uint8_t)((((frq / 1000U) * 2U * 3U) >> 8) & 0xFFU)
...
__ALIGN_BEGIN static uint8_t USBD_AUDIO_CfgDesc[USB_AUDIO_CONFIG_DESC_SIZ] __ALIGN_END =
{
  ...
  AUDIO_SAMPLE_FREQ(44100U),   /* Audio sampling frequency coded on 3 bytes */
  AUDIO_SAMPLE_FREQ(USBD_AUDIO_FREQ),   /* Audio sampling frequency coded on 3 bytes */
  AUDIO_SAMPLE_FREQ(USBD_AUDIO_FREQ_MAX),   /* Audio sampling frequency coded on 3 bytes */
  /* 14 byte*/
  ...
  AUDIO_OUT_EP,                         /* bEndpointAddress 1 out endpoint */
  USBD_EP_TYPE_ISOC,                    /* bmAttributes */
  AUDIO_PACKET_SZE_24(USBD_AUDIO_FREQ_MAX),    /* wMaxPacketSize in Bytes (Freq(Samples)*2(Stereo)*2(HalfWord)) */
  AUDIO_FS_BINTERVAL,                   /* bInterval */
  0x00,                                 /* bRefresh */
  0x00,                                 /* bSynchAddress */
  /* 09 byte*/
